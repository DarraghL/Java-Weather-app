...
public class OffalyMenuController {
    ...
    private void fetchWeatherData() {
        String apiUrl = "https://api.open-meteo.com/v1/forecast?latitude=53.0914&longitude=-7.9133&hourly=temperature_2m,relative_humidity_2m,apparent_temperature,precipitation_probability,precipitation,rain,showers,visibility,wind_speed_10m";
