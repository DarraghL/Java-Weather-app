...
public class LongfordMenuController {
    ...
    private void loadImages() {
        ...
        backButtonImageView.setImage(new Image(getClass().getResource(basePath + "LeinsterBackButton.png").toString()));
    }
    ...
    private void fetchWeatherData() {
        String apiUrl = "https://api.open-meteo.com/v1/forecast?latitude=53.7254&longitude=-7.7982&hourly=temperature_2m,relative_humidity_2m,apparent_temperature,precipitation_probability,precipitation,rain,showers,visibility,wind_speed_10m";
    ...
    private void parseWeatherData(String responseBody) {
        try {
            ...
            String weatherInfo = String.format(
                "Current weather in Longford Town:\n\n" +
                "Temperature: %.1f°C\n\n" +
                "Relative Humidity: %d%%\n\n" +
