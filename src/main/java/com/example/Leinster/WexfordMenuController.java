...
public class WexfordMenuController {
    ...
    private void fetchWeatherData() {
        String apiUrl = "https://api.open-meteo.com/v1/forecast?latitude=52.3342&longitude=-6.4575&hourly=temperature_2m,relative_humidity_2m,apparent_temperature,precipitation_probability,precipitation,rain,showers,visibility,wind_speed_10m";
    ...
    private void parseWeatherData(String responseBody) {
        try {
            ...
            String weatherInfo = String.format(
                "Current weather in Wexford Town:\n\n" +
                "Temperature: %.1f°C\n\n" +
                "Relative Humidity: %d%%\n\n" +
